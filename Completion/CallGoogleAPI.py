...
class TextTranslatorApp:
    ...
    def create_widgets(self):
        ...
        self.source_lang=ttk.Combobox(self.root, values=['en','es','fr','de','zh'])
        self.source_lang.set('en')

        label3=tk.Label(self.root, text='Choose target language:')
        self.target_lang=ttk.Combobox(self.root, values=['en','es','fr','de','zh'])
    ...
    def translate_text(self):
        api_key='AIzaSyAufymyJHYeWFHaBN74Xbi0RX-FtfVG9gg'
